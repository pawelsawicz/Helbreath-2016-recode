...
#define MAXITEMS			50
#define MAXBANKITEMS		121 // v1.2 120+1
...
#define WM_USER_GAMESOCKETEVENT	WM_USER + 4000
#define WM_USER_LOGSOCKETEVENT	WM_USER + 4001

#define WM_LOGIN_CONECTED			WM_USER + 100
...
//	int m_iAccountStatus;
	...
	unsigned char m_cSkillMastery[MAXSKILLTYPE]; // v1.4
